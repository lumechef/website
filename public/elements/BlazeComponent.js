...
import { Element, element, booleanAttribute, stringAttribute, css, attribute, } from '@lume/element';
...
export function jsonAttribute(value, context) {
    // @ts-ignore
    return attribute(attribute.json())(value, context);
}
let globalSheetPromise = null;
let BlazeComponent = (() => {
    let _classDecorators = [element('blaze-component')];
    ...
    var BlazeComponent = class extends _classSuper {
        ...
        #handleGlobalStyle() {
            ...
            if (!globalSheetPromise) {
                ...
                const link = document.head.querySelector('link[href*="accounts-ui"]');
